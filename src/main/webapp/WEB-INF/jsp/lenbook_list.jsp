...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            <table class="table table-border">
                ...
                <tbody>
                <c:forEach items="${pageInfo.list}" var="len">
                   <tr>
                       <td>${len.leid}</td>
                       <td>${len.bid}</td>
                       <td>${len.mid}</td>
                       ...
                       <td>
                           <c:if test="${len.retdate == null}">
                               <a href="${pageContext.request.contextPath }/updateL?leid=${len.leid}">归还图书</a>
                           </c:if>
                       </td>
                   </tr>
                </c:forEach>
  ...
  <c:choose>
  	...
  	<c:otherwise>
  		<li><a href="${pageContext.request.contextPath }/findLen">首页</a></li>
  	</c:otherwise>
  </c:choose>
      ...
      <a aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
  		...
  		<c:otherwise>
  			<li>
      <a href="${pageContext.request.contextPath }/findLen?pn=${pageInfo.prePage}" aria-label="Previous">
        <span aria-hidden="true">&laquo;</span>
      </a>
    </li>
  		</c:otherwise>
    ...
    <c:choose>
    	<c:when test="${pageInfo.pageNum==i }">
    		<li class="active"><a href="${pageContext.request.contextPath }/findLen?pn=${i}">${i}</a></li>
    	</c:when>
    	<c:otherwise>
    		<li><a href="${pageContext.request.contextPath }/findLen?pn=${i}">${i}</a></li>
    	</c:otherwise>
    ...
    <c:choose>
     ...
     <a aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
  		...
  		<c:otherwise>
  			<li>
      <a href="${pageContext.request.contextPath }/findLen?pn=${pageInfo.nextPage}" aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
      </a>
    </li>
  		</c:otherwise>
  ...
  <c:choose>
  	...
  	<c:otherwise>
  		<li><a href="${pageContext.request.contextPath }/findLen?pn=${pageInfo.pages+1}">末页</a></li>
  	</c:otherwise>
  </c:choose>
